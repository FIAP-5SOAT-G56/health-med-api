...
import CreateProdutoRequest from '@/infra/web/nestjs/doctors/dto/create-produto.request'
import ProdutoResponse from '@/infra/web/nestjs/doctors/dto/produto.response'
import UpdateProdutoRequest from '@/infra/web/nestjs/doctors/dto/update-produto.request'
import ProdutosController from '@/infra/web/nestjs/doctors/produtos.controller'
